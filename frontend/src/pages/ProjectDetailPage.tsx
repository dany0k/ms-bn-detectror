...
function InlineCharts({analysis}: { analysis: AnalysisResult }) {
    ...
    const binData = analysis.rps_bins.map(b => ({
        rps: +b.rps_mid.toFixed(1), P50: Math.round(b.p50_ms),
                ...
                <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start'}}>
                    <div>
                        ...
                        {project.description && <div
                            style={{color: 'var(--text2)', fontSize: 13, marginTop: 3}}>{project.description}</div>}
                    ...
                    <div style={{marginTop: 14, paddingTop: 14, borderTop: '1px solid var(--border)'}}>
                        <div style={{display: 'flex', gap: 8}}>
                            ...
                            <button className="btn-primary" onClick={handleLoad}
                                    disabled={loadBusy || !loadPath.trim()}>
                ...
                <div className="card" style={{padding: 0, overflow: 'hidden'}}>
                    <div style={{
                        ...
                        <span style={{
                            fontSize: 11,
                            color: 'var(--muted)'
                        }}>Всего: {total} · показаны {edges.length}</span>
                    </div>
                            ...
                            return (
                                <React.Fragment key={edge.name}>
                                    ...
                                    >
                                        ...
                                        <td style={{padding: '9px 12px'}}><span
                                            className="rpc-tag">{edge.rpc_type}</span></td>
                                        <td style={{
                                            padding: '9px 12px',
                                            color: 'var(--text2)'
                                        ...
                                        <td style={{
                                            padding: '9px 12px',
                                            fontWeight: 600,
                                            color: growthColor(edge.p95_growth)
                                        }}>
                                                    ...
                                                    <div style={{padding: 12}}>
                                                        <div className="error-box">
                                                            ...
                                                            <div style={{fontSize: 11, opacity: 0.8}}>
                                                                Удалите <code>bottleneck.db</code> и загрузите логи
                                                                заново.
                                                            </div>
                                                        </div>
                                                    </div>
